...
namespace CommonCore.RpgGame.World
{
    public class PlayerController : BaseController, ITakeDamage
    {
        ...
        public BaseHUDController HUDScript; //TODO should this be here?
        ...
        //hack for Lucidity
        public Action<ActorHitInfo> DamageHandler { get; set; }
        ...
        public override void Start()
        {
            ...
            if(!HUDScript)
            {
                HUDScript = BaseHUDController.Current;// as RpgHUDController; //I would not recommend this cast
            }
            ...
            if(!HUDScript && AutoinitHud)
            {
                ...
                HUDScript = BaseHUDController.Current;// as RpgHUDController;
            }
