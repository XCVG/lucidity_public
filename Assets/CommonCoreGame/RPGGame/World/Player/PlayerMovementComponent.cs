...
namespace CommonCore.RpgGame.World
{
    ...
    public class PlayerMovementComponent : MonoBehaviour
    {
        ...
        private bool AllowSprinting = true;
        [SerializeField]
        private bool AllowSlopeJumping = false;
        public bool UseBraking = true; //HACK for Lucidity
        [SerializeField]
        ...
        void OnControllerColliderHit(ControllerColliderHit hit)
        {
            ...
            else
            {
                ...
                Velocity += getBrakeVector(); //fuck, it was a sign issue all along!
            }
        ...
        protected void HandleMovement()
        {
            ...
            if (!GameState.Instance.PlayerFlags.Contains(PlayerFlags.Frozen) && !GameState.Instance.PlayerFlags.Contains(PlayerFlags.TotallyFrozen))
            {
                ...
                IsRunning = MappedInput.GetButton(DefaultControls.Sprint) && AllowSprinting;
