...
public static class SharedConsoleCommands
{
    ...
    {
        GameState.DeserializeFromFile(CoreParams.SavePath + Path.DirectorySeparatorChar + name);
    ...
    static void Save(string name)
    {
        ...
        GameState.SerializeToFile(CoreParams.SavePath + Path.DirectorySeparatorChar + name);
    }
